...
public class CourseSampleData {
    ...
    public static List<CourseEntity> getCourses() throws ParseException {
        ...
        courses.add(course);
        int i = Log.i(TAG, "getCourses(): "+ course.getCourse());
        ...
        course = new CourseEntity(2,2,2, "IT Capstone Written Project – C769", "Plan to Take",formatter.parse("07/01/2021"), formatter.parse("08/30/2020"));
        courses.add(course);
