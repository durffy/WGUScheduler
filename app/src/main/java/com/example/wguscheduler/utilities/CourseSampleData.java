...
public class CourseSampleData {
    public static List<CourseEntity> getCourses() throws ParseException {
        ...
        course = new CourseEntity(1,1,1, formatter.parse("1/1/2020"), formatter.parse("1/30/2020"));
        courses.add(course);

        course = new CourseEntity(2,1,2, formatter.parse("2/1/2020"), formatter.parse("2/30/2020"));
        courses.add(course);
